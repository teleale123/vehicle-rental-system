...
<script type="text/javascript">
  function isdelete()
  {
   ...
   if(!d)
   {
    alert(window.location='DELETEVEH.php');
   }
   else
   {
   return false;
...
<table style="border:1px solid gray" width="1000px">
<tr>
...
echo "<td >" ."<a href='DELETEVEH.php ?plate_no=$row[plate_no]' ><p onclick='isdelete();'>Delete</p> ". "</td>";
echo "</tr>";
}
echo "</table>";
mysql_close($con);
