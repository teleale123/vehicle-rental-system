...
<li><b><a href="contact Us.php">Contact Us</a></b></li>
...
?>
                  ...
                  <!--form  action="indx.php.php" method="post" name="form" onSubmit="return validate()"target=_self --->
                        <p align="center"><img src="Images/ert.png" width="278" height="83"/></p> 
...
<h1><marquee height="40" behavior="slide" direction="left" scrollamount="3"  align="center"><a href"#">
...
<p><font color="black" style='font-family:Times New Roman;font-size:19px;line-height:19px;left-align:
justify;padding-left:0px; margin-top:0px; '>
  <span class="F">Our new renting organization is a private limited
organization and its head office is located in wolaita sodo.The <strong>online vehicle rental System</strong> is  being developed for customers so that they can reserve their vehicles from  anywhere. This application takes information from the customers through filling  their details. A customer being registered in the website has the facility to  book a vehicle which he/she requires.</span></p>
<span class="F"></font></span>
<p align=center><img src="images/ermcar.jpg" height="578" width="470" >
</p>
</td>
</tr>
</table>
